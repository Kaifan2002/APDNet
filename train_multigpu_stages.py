...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if is_main_process():
            print(f"-------Best ssim epoch: {best_ssim_epoch+1}, SSIM: {best_ssim:.4f}, Best psnr epoch: {best_psnr_epoch+1}, PSNR: {best_psnr:.4f} | 修改spacial -------")
...
if __name__ == '__main__':
    ...
    # yaml 多尺度配置
    parser.add_argument('--yml_path', type=str, default="./configs/LOL_v2_real.yaml")
