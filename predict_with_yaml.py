...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/qiaokaifan/qiaokaifan_code/APDNet-main/snapshots/NTIRE2026/20260204/models/best_psnr_model.pth',help='.pth')
    parser.add_argument('--device', type=str, default='cuda:1', help='device')
    parser.add_argument('--output_dir', type=str, default='./result', help='output_dir')
    parser.add_argument('--yml_path', type=str, default="/home/qiaokaifan/qiaokaifan_code/APDNet-main/configs/NTIRE2026LLIE_paired.yaml")
